...
Обратите внимание, что в инпуте пользователт указывает конечную дату, а в функцию необходимо передать срок в месяцах. Предварительно рассчитайте срок на основе введеной даты.
...
5) Посчитайте общую сумму, которую придется заплатить клиенту.
6) Выведите результат в консоль, а также верните его из функции.
